...
def write_index(input_dict):
    output_file = open('E:/IR/Results/stemstop/ii_1.txt', 'a')
    out_pkl = open("E:/IR/Results/stemstop/c_1.pkl", 'wb')
    temp_cat = {}
...
def merge_index(file_no):
    ...
    cat_file_1 = open("E:/IR/Results/stemstop/c_1.pkl", 'rb')
    cat_file_2 = open("E:/IR/Results/stemstop/c_" + str(file_no) + ".pkl", 'rb')
    cat_dict_1 = pickle.load(cat_file_1)
    cat_dict_2 = pickle.load(cat_file_2)
    ii_file_1 = open("E:/IR/Results/stemstop/ii_1.txt", 'rb')
    ii_file_2 = open("E:/IR/Results/stemstop/ii_" + str(file_no) + ".txt", 'rb')
    global_index_dict = {}
    ...
    os.remove("E:/IR/Results/stemstop/c_1.pkl")
    os.remove("E:/IR/Results/stemstop/ii_1.txt")
    os.remove("E:/IR/Results/stemstop/c_" + str(file_no) + ".pkl")
    os.remove("E:/IR/Results/stemstop/ii_" + str(file_no) + ".txt")
...
def dump_data(fileno):
    ...
    str1 = 'E:/IR/Results/stemstop/ii_' + str(fileno) + ".txt"
    str2 = 'E:/IR/Results/stemstop/c_' + str(fileno) + ".pkl"
...
f1 = open('E:/IR/Results/stemstop/term_ids.txt', 'a')
for key in termid_dict.keys():
    f1.write('%s  %s \n' % (key, termid_dict[key]))
termid_pkl = open("E:/IR/Results/stemstop/term_ids.pkl", 'wb')
pickle.dump(termid_dict, termid_pkl)
doc_pkl = open("E:/IR/Results/stemstop/doc_ids.pkl", 'wb')
